...
public class IMItemElements {
	...
	/*@FindBy(xpath = "//*[@id='s2id_identifierType']/ul")
	WebElement txt_identifiertype;*/
	...
	public void enterItemListInfo(String sItem, String sName,String sDescription, String sItemclass,
		...
		try {
			...
			inAction.inputText(driver, txt_minqty, sMinqty,
					"Enter sMinqty : " + sMinqty);
			inAction.inputText(driver, txt_maxqty, sMaxqty,
					"Enter sMaxqty : " + sMaxqty);
	...
	public void enterIdentificationListInfo(String sIdentifierdropdown,String sUPC,String sCaseUPC,
		...
		try {
			...
			inAction.buttonClick(driver, btn_identifiertype, 
					"Click button : btn_identifiertype");
			Thread.sleep(1000);
			inAction.selectByTextInDropdown(driver, list_identifiertype, sIdentifierdropdown);*/
			Thread.sleep(1000);
			selectIdentifierType(sIdentifierdropdown);
			Thread.sleep(2000);
			inAction.inputText(driver, txt_UPC, sUPC,
					"Enter sUPC : " + sUPC);
	 ...
	 */
	public void enterMeasurementListInfo(String sEachweight,String sEachheight,String sEachlength,
		...
		try {
			...
			inAction.inputText(driver, txt_qty, sQty,
					"Enter sQty : " + sQty);
			inAction.inputText(driver, txt_qtylayer, sQtylayer,
					"Enter sQtylayer : " + sQtylayer);
			inAction.inputText(driver, txt_pallet, sPallet,
					"Enter sPallet : " + sPallet);
	 ...
	 */
	public void enterManufactureInfo(String sManufacturename,String sItemnumber,String sMake,
			String sModel,String sSupplier, String sSuppliernumber ){ 
		...
		try {
			...
			inAction.inputText(driver, txt_make, sMake,
					"Enter sMake : " + sMake);
			inAction.inputText(driver, txt_model, sModel,
					"Enter sModel : " + sModel);
	...
	inAction.selectByTextInDropdown(driver, list_itemclass, sItemclassdropdown);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	inAction.selectByTextInDropdown(driver, list_itemtype, sItemTypedropdown);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void selectInventoryType(String sInventorytype,String sInventorydropdown) {
		try {
	...
	inAction.selectByTextInDropdown(driver, list_inventorytype, sInventorydropdown);
	...
	inAction.inputText(driver, txt_uom, sUOM,
			"Enter sUOM : " + sUOM);
...
/**
 * This method used to click the Batch code toggle button
 * @param sBatchcode
 */
