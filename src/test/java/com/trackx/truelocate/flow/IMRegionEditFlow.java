...
public class IMRegionEditFlow extends GeneralActions {
	WebDriver driver;
	...
	public void regionEditFlow(String sValue,String sCode,String sName)throws Exception {
		try {
			imregionelements.menuClick();
			Thread.sleep(1000);
			ReusableActions.takeSnapshot(driver, className);
			//commonElements.clickValue(sValue);
			imregionelements.clickValue(driver,sValue);
